...
public class NodeRegistrationController {
    ...
    public ResponseEntity<Map<String, Object>> registerNode(@RequestBody Map<String, Object> nodeData) {
    ...
    public ResponseEntity<Map<String, Object>> nodeHeartbeat(@RequestBody Map<String, Object> heartbeatData) {
        try {
