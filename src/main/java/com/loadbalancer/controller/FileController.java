...
public class FileController {
    ...
    public ResponseEntity<?> uploadFile(
        ...
        try {
            ...
            log.info("Selected node {} for file upload, size: {}", selectedNode.getContainerId(), file.getSize());

            String uploadUrl = String.format("http://%s:%d/api/v1/files/upload",
            ...
            if (selectedNode != null) {
                long duration = System.currentTimeMillis() - startTime;
                loadBalancerService.recordRequest(selectedNode.getContainerId().toString(), false, duration);
            }
    ...
    public ResponseEntity<?> downloadFile(
        ...
        try {
            ...
            String downloadUrl = String.format("http://%s:%d/api/v1/files/%d",
    ...
    public ResponseEntity<?> deleteFile(
        ...
        try {
            node = loadBalancerService.getNodeForFile(fileId);
            String deleteUrl = String.format("http://%s:%d/api/v1/files/%d",
                    node.getHostAddress(), node.getPort(), fileId);
